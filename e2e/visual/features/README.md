...
| Meine Inhalte, Listenansicht - Set mit ausstehender Aktualisierung: Abzeichen "Aktualisierung verfügbar" und Zeilen-Knopf "Aktualisieren" (#3081; Upstream per page.route auf 1.1.0 gehoben) | `content-updates/listenansicht-aktualisierung.png` | `content-updates/listenansicht-aktualisierung.mobile.png` | #3081 |
