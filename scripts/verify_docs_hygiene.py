        ...
        json.dumps(
            {
                ...
                "rationale": (
                    ...
                    "remainder is C-stock the curated list does not know and "
                    "all-caps grep keys (the generator-owned string was fixed "
                    "in the generator, #2465). Detection is manuscript-tools' "
