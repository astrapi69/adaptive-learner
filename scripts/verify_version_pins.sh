...
# literal slips past every gate (Phase 40 release-automation audit
# GAP-B). Output is ADVISORY (does not exit 1) — discovery findings
# are candidates for review, not gates. Add new locations to either
# sync_versions.py's collect_targets() or this script's
# discover_version_literals.sh KNOWN_FILES list.
