      ...
      >
        <div className="sticky top-0 z-[1] flex items-center justify-between border-b border-border bg-[var(--surface)] px-5 py-4">
          ...
          <SheetClose asChild>
            <Button
              ...
              title={tooltipsOn ? t("ui.common.close", "Close") : undefined}
        ...
        >
          ...
          {entry.docs_slug && (
            <div className="mt-5">
              <a
                href={docsUrlForSlug(entry.docs_slug, lang)}
                target="_blank"
                rel="noopener noreferrer"
                data-testid="help-drawer-learn-more"
                className="inline-flex items-center gap-1 rounded-sm border border-border bg-[var(--surface-2)] px-3 py-2 text-sm font-medium text-[var(--accent)] no-underline hover:bg-[var(--surface)]"
              >
