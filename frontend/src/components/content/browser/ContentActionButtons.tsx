 ...
 *
 * The four actions — Import Lesson / Import Chat / Anki export / Learning
 * Path — living in the **Import tab** since the content IA redesign.
 *
 * #3006 removed the fifth, "Create New Lesson": creating has its own tab in
 * the hub now, so a button pointing at the neighbouring tab is noise. That
 * revises #1253's "they are all import- or creation-related" grouping for the
 * creation half only; the four here are two imports, one export and one
 * navigation, and their placement is a separate decision.
...
/** The four content import/export/navigation action buttons. */
