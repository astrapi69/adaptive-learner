...
import { requireRow, rowToProfile } from "../db/dexie-rows";
import { calculateProfile, questionsForLang } from "../ai/assessment";
import { sendMessage, sendMessageStream, startSession } from "../ai/session-flow";
import { aggregateProgress, buildCommitFromSession, rowToCommit } from "../gamification/tracking";
import { buildSpacedRecommendations, rankTools, recencyFromCommits } from "../integrations/tools";
...
import type { LearningProfileRow, LearningSessionRow, MethodSwitchRow, SessionRatingRow } from "../db/db";
