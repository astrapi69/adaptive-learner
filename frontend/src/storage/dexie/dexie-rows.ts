...
export function rowToSettings(row: UserSettingsRow): UserSettings {
  ...
  return {
    ...
    has_perplexity_key: !!row.api_key_perplexity,
    ...
    model_override_perplexity: row.model_override_perplexity ?? null,
    ...
    key_source_perplexity: row.api_key_perplexity ? "settings" : "none",
    ...
    key_preview_perplexity: maskSecret(row.api_key_perplexity ?? null),
    created_at: row.created_at,
    updated_at: row.updated_at,
  };
}
