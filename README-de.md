...
Aktive Entwicklung. Das aktuelle Release ist **v2.8.2** (Sicherheits-Patch auf v2.8.0 - CSP #2197, Debug-Default #2198, Lesson-Validator-Eval #2205; v2.8.1 wurde nie veröffentlicht); das v2.8.0-Kernstück ist dessen
