...
[![Version](https://img.shields.io/badge/version-v2.13.0-blue)](https://github.com/astrapi69/adaptive-learner/releases/latest)
...
Aktive Entwicklung. Das aktuelle Release ist **v2.13.0** (Sicherheits-Patch auf v2.8.0 - CSP #2197, Debug-Default #2198, Lesson-Validator-Eval #2205; v2.8.1 wurde nie veröffentlicht); das v2.8.0-Kernstück ist dessen
