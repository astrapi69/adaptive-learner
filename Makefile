...
.PHONY: dev dev-bg dev-bg-logs dev-down dev-backend dev-frontend dev-secret dev-lan build-frontend stop restart fix-watchers \
       ...
       ci ci-full rule-change-log rule-change-log-check verify-docs verify-docs-fix verify-gate-rule-links verify-lessons-inventory verify-check-inventory verify-normative-changes check-mkdocs-orphans verify-docs-discipline docs-checklist \
