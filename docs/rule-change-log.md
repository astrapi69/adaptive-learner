...
| 2026-09-08 | `10ecaef` | #3016 | lessons/ci-gates.md erhält unter der #2696-Lektion den Nachtrag #3016 mit drei Regeln (das Höhenmaß muss den wirklich scrollenden Container nennen; wer einen kaputten Mechanismus ersetzt, prüft dessen Annahmen mit; fail closed statt stillem Abschneiden). Der Korpus-Deckel steigt dafür um 1645 Zeiche |
