...
simplemente trae un conjunto nuevo.

## Cómo funcionan

- Recibes hasta **3 misiones** al día, mostradas en el Panel
  principal entre tu racha y tus insignias.
- Las misiones son **alcanzables** para cualquiera que use la
  aplicación entre 15 y 30 minutos, y la dificultad **se adapta**
  a ti: un aprendiz nuevo recibe objetivos suaves de «aprendizaje»
  y «exploración»; una vez que tienes algo de historial de errores,
  se suman misiones de «repaso» y «dominio».
- Son **deterministas**: el mismo día te muestra las mismas
...
**Ajustes > Aprendizaje > Misiones diarias** te permite:
