...
| Section | Contenu |
|---------|---------|
| [Concept](concept/philosophy.md) | Fondements théoriques, méthodes, cycle |
| [Guide utilisateur](user-guide/getting-started.md) | Toutes les fonctionnalités expliquées |
| [Développeurs](developer/setup.md) | Architecture, plugins, déploiement, tests |
| [Référence API](api/overview.md) | Endpoints REST, hooks, modèles |

---

## État actuel

Adaptive Learner est en développement actif. La version actuelle est
documentée dans [CHANGELOG](https://github.com/astrapi69/adaptive-learner/blob/main/docs/CHANGELOG.md).

Signaler un problème ou suggérer une amélioration :
[Issues GitHub](https://github.com/astrapi69/adaptive-learner/issues)
