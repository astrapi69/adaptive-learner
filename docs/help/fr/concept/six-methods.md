...
Adaptive Learner implémente six méthodes d'apprentissage issues de la
recherche en sciences de l'éducation. Chacune a ses propres forces,
faiblesses et cas d'usage optimaux.
...
**Idéale pour :** grammaire, formules mathématiques, syntaxe de programmation,
tout sujet avec des règles explicites.
...
**Idéale pour :** reconnaissance de schémas, grammaire en contexte, gammes
musicales, concepts statistiques.
...
**Idéale pour :** consolidation après d'autres méthodes, situations de stress
élevé, exploration de sujets complexes.
...
**Idéale pour :** langues appliquées, préparation à des situations spécifiques,
après les premières bases.
...
**Idéale pour :** apprenants débutants, sujets variés, quand vous faites
confiance au système pour optimiser.

---

## Choisir la bonne méthode

Le test d'évaluation produit un **profil pondéré** sur les six méthodes.
Vous pouvez suivre cette recommandation ou sélectionner n'importe quelle
méthode manuellement au démarrage de la session.

Les profils ne sont pas figés : le système ajuste ses recommandations à
chaque session complétée et chaque changement de méthode. Si une méthode
génère du stress pendant plusieurs sessions, le recommandeur de changement
de méthode se déclenche automatiquement.
