...
Missionen, Anki-Karten, Notizen und mehr) **plus deine
heruntergeladenen Content-Sets**. Nichts Wichtiges bleibt zurück.
...
Das Format ist eine einzige JSON-Datei; es gibt kein proprietäres
Archivformat.
