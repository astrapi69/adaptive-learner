...
zur Verfügung stellen. Diese Seite gibt den Überblick; die
ausführliche Schritt-für-Schritt-Anleitung steht im
...
Adaptive-Learner-Format enthält. Ein Set ist eine Sammlung von
Lektionen für ein Sprachpaar und Niveau (z. B. "Spanisch A1 für
Deutschsprachige") oder für ein Sachgebiet (z. B. "Python-Grundlagen").
...
- Ein **GitHub-Repository** (öffentlich; privat ist per Repo-Token
  ebenfalls möglich).
...
Erklärungen geschrieben sind) ist der oberste Ordner, Zielsprache und
Niveau bilden den nächsten:
...
Datei. Geprüft werden Schema, Verzeichnisstruktur und die
Qualitäts-Mindestanforderungen (>= 5 Übungen, >= 2 Übungstypen, >= 1
...
**Einstellungen > Daten > Content-Repositories**: URL einfügen, die App
...
In die **Empfohlenen Repositories** in der App kommt ein Repo nur über
die kuratierte `recommended-repos.json` des Projektteams - das ist der
Kanal für die offizielle Empfehlung (Trust 3).

---

## Trust-Levels

Das Trust-Level sagt, wie stark der Inhalt geprüft wurde - es geht um
Herkunft und Prüfung, nicht um ein Qualitätsurteil.

| Level | Name | Bedeutung |
|-------|------|-----------|
| **1** | Validiert | Schema korrekt, Qualitäts-Mindestanforderungen bestanden - automatisch beim Sync. Inhalt nicht einzeln geprüft. |
| **2** | Verifiziert | Von der Community beigetragen und von einem Maintainer inhaltlich geprüft. |
| **3** | Offiziell | Vom Projektteam kuratiert und qualitaetsgesichert. |

Für Trust 2+ gilt ein höherer Anspruch als die technischen Minima:
korrekte Übersetzungen, Artikel/Genus, vollständige Akzente, sinnvolle
Progression, plausible Distraktoren und kulturelle Korrektheit. Eine
optionale **KI-Prüfung** in der App hilft Autoren, solche Probleme vor
dem Teilen zu finden (siehe EXP-033); sie ist beratend und blockiert das
Teilen nie.

---

## Gegenseitigkeit für Kurse und Webseiten (EXP-029)

Lektionen und Sachgebiete können **Begleitmedien** tragen (Videos,
Podcasts, Artikel, Bücher, Kurse, Webseiten). Der Filter für
...
Es enthält `docs/`, Vorlagen je Domäne, eine vollständige
...
- **[Vollständiger Content-Repo-Guide](https://github.com/astrapi69/adaptive-learner/blob/main/docs/reference/CONTENT-REPO-GUIDE.md)**
