...
- Recebe até **3 missões** por dia, mostradas no Dashboard entre
  a sua sequência e os seus emblemas.
- As missões são **atingíveis** por qualquer pessoa que use a
  aplicação 15 a 30 minutos, e a dificuldade **adapta-se** a si:
  um novo aprendente recebe objetivos suaves de "aprendizagem" e
  "exploração"; assim que tiver um historial de erros, missões de
  "revisão" e "domínio" também surgem.
- São **determinísticas**: o mesmo dia mostra-lhe as mesmas
