...
| Secção | Para quem |
|---|---|
| [Guia do utilizador](user-guide/getting-started.md) | Aprendentes que querem usar a aplicação |
| [Conceitos](concept/philosophy.md) | Qualquer pessoa que queira perceber a teoria |
| [Referência da API](api/overview.md) | Programadores que integram ou constroem |
| [Guia do programador](developer/setup.md) | Contribuidores e auto-hospedagem |
...
Ver [Notas de Lançamento](developer/release.md) para o estado atual da versão.
